            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <form class="form-horizontal form-label-left" action="../insert_cierre_guardia_desp.php?ac=1" method="post" id="demo-form" data-parsley-validate>
