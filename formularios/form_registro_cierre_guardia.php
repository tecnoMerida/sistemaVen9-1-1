                        <div class="field item form-group"><!-- //     procedimiento realizado de la novedad   //  -->
                          ...
                          <div class="col-md-6 col-sm-6">
                            <textarea type="text" name="cierre_g" id="cierre_g" class="resizable_textarea form-control" placeholder="Escribe aquí entrega y cierre de guardia" maxlength="500" title="Llene este campo con una descripción al momento de la entrega y cierre de guardia" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.':;/-0-9]{8,500}" id="fname" onblur="upperCase()" ></textarea>
                          </div>
                        </div>
                   ...
                   <div><!-- // Registro de usuario de entrada toma valor de la tabla personal //  -->
                         <input type="hidden" name="usuario_salida_id" id="usuario_salida_id" value="<?php echo $cedula; ?>" required />
                   </div>
