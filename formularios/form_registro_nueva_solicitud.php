                              ...
                              <div class="panel-body">
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-3 col-sm-3">
                                    <input type="text" name="p_nombre_sol" id="p_nombre_sol" class="form-control" placeholder="Nombre solicitante" minlength="2" maxlength="40" value="" title="Llene este campo con nombre y apellido de quien realiza la llamada" pattern="[A-Za-záéíóúüñÁÉÍÓÜÚÑ1-9 -]{1,40}" required />
                                  </div>
                                  <div class="col-md-3 col-sm-3">
                                    <input type="text" id="p_apellido_sol" name="p_apellido_sol" class="form-control" placeholder="Apellido solicitante" minlength="2" maxlength="40" value="" title="Llene este campo con nombre y apellido de quien realiza la llamada" pattern="[A-Za-záéíóúüñÁÉÍÓÜÚÑ1-9 -]{1,40}" required />
                                  </div>
                                </div>
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <textarea type="text" name="detalles_solicitud" id="detalles_solicitud" class="resizable_textarea form-control" placeholder="Detalles de la solicitud" title="Llene este campo con detalles del evento" required></textarea>
                    </div>
                </div>
                          ...
                          <div class="panel">
                            ...
                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                              <div class="panel-body">
                                ...
                                if($organismo == 1 ){
                                  $consulta_op = pg_query($dbconn, "SELECT * FROM public.personal WHERE grupo_guardia_id = $grupos_guardia AND estatus_personal_id = 1 AND organismos_id IN (1,4)");
                                  if (!$consulta_op) {
                                    echo "Ocurrió un error.\n";
                                    exit;
                                  }
                                  ...
                                  $consulta_op = pg_query($dbconn, "SELECT * FROM public.personal WHERE grupo_guardia_id = $grupos_guardia AND estatus_personal_id = 1 AND organismos_id IN (2,4)");
                                  if (!$consulta_op) {
                                    echo "Ocurrió un error.\n";
                                    exit;
                                  }
                                  ...
                                  $consulta_op = pg_query($dbconn, "SELECT * FROM public.personal WHERE grupo_guardia_id = $grupos_guardia AND estatus_personal_id = 1 AND organismos_id IN (3,4)");
                                  if (!$consulta_op) {
                                    echo "Ocurrió un error.\n";
                                    exit;
                                  }
                                  ...
                                  $consulta_op = pg_query($dbconn, "SELECT * FROM public.personal WHERE grupo_guardia_id = $grupos_guardia AND estatus_personal_id = 1 AND organismos_id IN (4,5)");
                                  if (!$consulta_op) {
                                    echo "Ocurrió un error.\n";
                                    exit;
                                  }
