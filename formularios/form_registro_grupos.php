  ...
  <div class="">
    ...
    <div class="">
      <div class="col-md-12 col-sm-12">
        <div class="x_panel">
          <div class="x_title">
            <h2><i class="fa fa-bars"></i> Nuevo Grupo </h2>
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="x_content">
                  ...
                  <div class="col-md-6 col-sm-6" align="center">
                    ...
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Grupo registrado con EXITO!!!</strong></div>';
                    } elseif ($_GET['msg'] == "3") {
                      echo '<div class="alert alert-secondary alert-dismissible msn1">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Grupo NO registrado</strong></div>';
                    }
                  ...
                  <form class="" action="../insertar_organismo.php?ac=3" method="post" data-parsley-validate>
                    <span class="section">
                      <p></p>
                    </span>
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <input type="text" name="nombre_grupo" id="nombre_grupo" class="form-control" placeholder="Ingresa nuevo grupo" title="Llene este campo con el nombre de un nuevo grupo" minlength="3" maxlength="30" pattern="[a-zA-Z0-9 -]{3,30}" required="required" />
                      </div>
                          ...
                          <div class="card-box table-responsive">
                            <div class="col-md-8 col-sm-8 " style="margin-bottom:-50px;">
                              <p class="text-muted font-13 m-b-30">
                                Realize una busqueda por número Id, Nombre del grupo</p>
                            </div>
                            ...
                            if ($buscar == '') {
                              ...
                              if ($buscar != '') {
                                $org = $buscar;
                                $filtro1 = "WHERE nombre_grupo LIKE '$org%' ";
                                $consulta = pg_query($dbconn, "SELECT * FROM grupos_guardia $filtro1 ");
                                ...
                                if ($reg01) {
                                  ...
                                  $grupo = $buscar;
                                  $filtro = "WHERE nombre_grupo LIKE '$grupo%' ";
                                }
                              }
                            }
                            /********************************     FIN FILTRO BUSQUEDA     ************************************/
                            /********************************     CONSULTA DESPUES DEL FILTRO     ***************************/
                            $consulta_pag = pg_query($dbconn, "SELECT * FROM public.grupos_guardia $filtro ");
                              ...
                              <tbody>
                                ...
                                if ($total_rows_pag != 0) {
                                  ...
                                  do {
                                    ...
                                    echo "<td><a href=modificar_grupos.php?id=" . $row[0] . " ><button class='btn btn-primary' type='submit' action='' value='EDITAR'>EDITAR</button></a></td>\n";
                                    echo "</tr><br/>";
                                    //            }
