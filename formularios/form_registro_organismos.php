                ...
                <div class="x_content">
                  ...
                  <form class="" action="../insertar_organismo.php?ac=1" method="post" data-parsley-validate>
                    ...
                    <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Organismo<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" placeholder="Ingresa nuevo organismo" title="Llene este campo con el nombre de un nuevo organismo" minlength="6" maxlength="30" name="nombre_oganismos" pattern="[A-Za-z0-9 -]{6,30}" required="required" />
                      </div>
                    </div>
                              ...
                              <div class="card-box table-responsive">
                                <div class="col-md-8 col-sm-8 ">
                                  <p class="text-muted font-13 m-b-30">
                                    Realize una busqueda por número Id, Nombre del organismo</p>
                                </div>
                                ...
                                if ($buscar == '') {
                                  ...
                                  if ($buscar != '') {
                                    ...
                                    $consulta = pg_query($dbconn, "SELECT * FROM organismos $filtro1 ");
                                    ...
                                    if ($reg01) {
                                      ...
                                      $organismo = $buscar;
                                      $filtro = "WHERE nombre_oganismos LIKE '$organismo%' ";
                                    }
                                  }
                                }
                                /********************************     FIN FILTRO BUSQUEDA     ************************************/
                                  ...
                                  <tbody>
                                    ...
                                    if ($total_rows_pag != 0) {
                                      ...
                                      do {
                                        ...
                                        echo "<td><a href=modificar_personal.php?id=" . $row[0] . " target='_blank'><button class='btn btn-primary' type='submit' action='' value='EDITAR'>EDITAR</button></a></td>\n";
                                        echo "</tr><br/>";
                                        //            }
