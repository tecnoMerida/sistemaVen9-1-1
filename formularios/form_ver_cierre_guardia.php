                    ...
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        ...
                        <div class="field item form-group">
                          ...
                          <div class="col-md-6 col-sm-6">
                            <textarea type="text" name="apertura_g" id="apertura_g" class="resizable_textarea form-control" placeholder="Escribe aquí apertura y recepción de guardia" value="<?php echo $reg[4];  ?>" title="Llene este campo con una descripción al momento de la apertura y recepción de guardia" readonly><?php echo strtoupper($reg[4]);  ?></textarea>
                          </div>
                        </div>
