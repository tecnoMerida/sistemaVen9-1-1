...
require('plantilla.php');
    ...
    //consulta 2
    $usuario_entrada = $reg['usuario_entrada_id'];
...
$pdf = new PDF('P','mm','A4');
$pdf->AddPage();
$title = 'Reporte apertura de guardia';
$pdf->SetTitle($title);

$pdf->SetFont('Arial','B',14);
$pdf->SetX(20);
$pdf->Cell(170,20,utf8_decode('Apertura de Guardia'),0,1,'C');

require('directivo_2.php'); 

$pdf->SetFont('Arial','',12);
$pdf ->Cell(77,6,utf8_decode(' es  realizada   la  recepción  y   apertura'),0,1);
$pdf->SetX(20);
$pdf->SetFont('Arial','',12);
...
$pdf->SetFont('Arial','',12);
$pdf->SetX(20);
$pdf->Cell(170,6,utf8_decode('Dando   por   registrada   la  recepción  y   apertura   de  guardia   correspondiente  con  la '),0,1);
$pdf->SetX(20);
$pdf->Cell(170,6,utf8_decode('siguiente descripción: '),0,1);
$pdf->SetFont('Arial','B',12);
$pdf->SetX(20);
$pdf->MultiCell(170,8,utf8_decode(''.strtoupper($reg['apertura_g']).'.'),0,1);
