...
$pdf->SetX(20);
$pdf->Cell(170,10,utf8_decode('Control de Bienes Muebles Salida'),0,1,'C');
...
if($reg_org['id'] != 5 AND $reg_org['id'] != 9 ) {
        ...
        $pdf->SetX(20);
        $pdf->SetFont('Arial','',12);
        $pdf ->Cell(75,6,utf8_decode(', al  momento  de  la  salida. '),0,1);
        ...
        $pdf->SetFont('Arial','',12);
        $pdf ->Cell(75,6,utf8_decode(', al  momento  de  la  salida. '),0,0);
