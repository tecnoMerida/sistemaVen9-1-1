                  ...
                  <form class="form-inline" id="consul_guardia" name="form_consul" method="POST" action="">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select class="form-control" name="organismo_id" id="organismo_id" title="Seleccione el organismo a consultar" required>
                        <option value="<?php if ($reg_consulta == '') {
                                          echo '';
                                        } else {
                                          echo $reg_consulta[0];
                                        } ?>"><?php if ($reg_consulta == '') {
                                                echo '-Seleccione Organismo-';
                                              } else {
                                                echo strtoupper($reg_consulta[1]);
                                              } ?></option>
                        <?php
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="date" id="fecha_entrada" name="fecha_entrada" class="form-control" placeholder="Fecha Entrada" title="Seleccione fecha de inicio a consultar" value="<?php echo $fecha_entrada1; ?>" required>
                    </div>
                    ...
                    <div class="col-md-2">
                      <button type="submit" class="btn btn-primary" title="Presione el boton para realizar la consulta">Buscar</button>
                    </div>
                  </form>
                </div>
                <!-- ****************************** Fin de Formulario **************************************-->
