...
//$consulta_grupo1 = pg_query($dbconn, "SELECT * FROM public.personal_datos WHERE personal_grupos_guardia_id = $id_grupo_guardia");
//$reg_grupo1 = pg_fetch_array($consulta_grupo1);

//$cedula = $reg_grupo1['personal_cedula_sup'];
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!-- Inicio Formulario de Apertura de Guardia -->  
                      <form class="form-horizontal form-label-left" action="../insert_apertura_guardia.php?ac=4" method="POST" id="demo-form" data-parsley-validate>
