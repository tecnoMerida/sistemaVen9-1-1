...
<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <a href="../administrador/principal.php" class="site_title" title="Ir a la página principal del sistema"><small><span> &nbsp Inicio</span></small></a>
            </div>

          <div  id="title_menu" align="center">
              <a href="../administrador/principal.php" class="site_title" title="Ir a la página principal del sistema"><small><span>SLDN 911</span></small></a>
            </div>
...
<!--                  <li><a href="../cookie/logout.php"><i class="fa fa-sign-out"></i> Cerrar Sesión <span class="label label-success pull-right"></span></a>
                ...
                <li><a><i class="fa fa-sitemap"></i> Solicitudes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../supervisor/cierre_solicitud.php">Cierre Solicitud</a></li>
                      <li><a href="../supervisor/consulta_solicitud.php">Consulta 911</a></li>
                    </ul>
                  </li>
...
<!--                      <li><a href="../supervisor/contactos.php">Contactos</a></li>-->
                ...
                <li><a><i class="fa fa-sitemap"></i> Solicitudes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../despachador/cierre_solicitud.php">Cierre Solicitud</a></li>
                      <li><a href="../despachador/consulta_solicitud.php">Consulta 911</a></li>
                    </ul>
                  </li>
...
<!--                      <li><a href="../despachador/contactos.php">Contactos</a></li>-->
            ...
            <div class="sidebar-footer hidden-small">
              <a data-toggle="tooltip" data-placement="top" class="cerrar" title="Cerrar Sesión" href="../cookie/logout.php">
